...
function ProductCard({ product }: Props) {
  return (
    <div className="flex flex-col items-start justify-center border-[1px] rounded-md hover:scale-[1.02] transition-all cursor-pointer">
      <div className="relative w-full aspect-[3/2] min-w-[200px] ">
        <Image src={product?.image} alt="Logo" fill objectFit="cover" />


        <div className="absolute bottom-0 left-0">
          <LottieFileBuilder animationData={animationData} width={80} height={80} loop={false}/>
      ...
      <div className="flex flex-col gap-5 px-3 py-3 w-full">
        ...
        <div className="flex items-center justify-between w-full">
          ...
          <button className="flex items-center justify-center gap-2 text-sm bg-brand-200 text-black px-4 py-2 hover:scale-[1.02] transition-all">
            <IoCartSharp />
            Add to Cart
          </button>
        </div>
