    ...
    <>
      <section className="space-y-5 mb-8" id="Introduction">
        ...
        <p>
          ...
          Conditions. If you do not agree to these Terms and Conditions of use,
          you shall not use this website.
        </p>
        <p>
          The Site reserves the right to change, modify, add, or remove portions
          of these Terms and Conditions of use at any time. Changes will be
          ...
          these Terms and Conditions of use constitutes your acceptance of those
          changes.
        </p>
      </section>

      <section className="space-y-5 mb-8">
        <h1 className="font-semibold py-2 uppercase" id="use-of-site">
          Use of the site
        </h1>
        <p>
          You are either at least 18 years of age or are accessing the Site
          under the supervision of a parent or legal guardian. We grant you a
          non-transferable and revocable license to use the Site, under the
          Terms and Conditions described, for the purpose of shopping for
          building materials and accessing services available on the Site.
          Commercial use or use on behalf of any third party is prohibited,
          except as explicitly permitted by us in advance. Any breach of these
          Terms and Conditions shall result in the immediate revocation of the
        ...
        <p>
          ...
          and to promptly update such information if there are any changes.
          Every user of the Site is solely responsible for keeping passwords and
          other account identifiers safe and secure. The account owner is
          entirely responsible for all activities that occur under such a
        ...
        <p>
          ...
          or in connection with, your failure to comply with this section.
          During the registration process you agree to receive promotional
          messages from the Site. You can subsequently opt out of receiving such
          promotional messages by clicking on the link at the bottom of any
          promotional message.
        </p>
      </section>

      <section className="space-y-5 mb-8">
        <h1 className="font-semibold py-2 uppercase" id="user-submissions">
          User Submissions
        </h1>
        <p>
        ...
        <p>
          ...
          the name that you submit, in connection with such review, comment, or
          other content. You shall not use a false e-mail address, pretend to be
      ...
      <section className="space-y-5 mb-8">
        <h1 className="font-semibold py-2 uppercase" id="order-acceptance">
          Order Acceptance and Pricing
        </h1>
        <p>
          Please note that there are cases when an order cannot be processed for
          various reasons. The Site reserves the right to refuse or cancel any
          order for any reason at any given time. You may be asked to provide
        ...
        <p>
          ...
          event that an item is mispriced, we may, at our own discretion, either
      ...
      <section className="space-y-5 mb-8">
        <h1 className="font-semibold py-2 uppercase" id="trademarks">
          Trademarks and Copyrights
        </h1>
        <p>
          All intellectual property rights, whether registered or unregistered,
          in the Site, information content on the Site and all the website
          design, including, but not limited to, text, graphics, software,
          photos, video, music, sound, and their selection and arrangement, and
          all software compilations, underlying source code and software shall
          remain our property. The entire contents of the Site also are
          protected by copyright as a collective work under Ghanaian copyright
          laws and international conventions. All rights are reserved.
        </p>
      </section>

      <section className="space-y-5 mb-8">
        <h1 className="font-semibold py-2 uppercase" id="applicable-law">
          Applicable Law and Jurisdiction
        </h1>
        <p>
          These Terms and Conditions shall be interpreted and governed by the
          laws in force in the Republic of Ghana. Each party hereby agrees to
          submit to the jurisdiction of the courts of Ghana and to waive any
          objections based upon venue.
        </p>
      </section>

      <section className="space-y-5 mb-8">
        <h1 className="font-semibold py-2 uppercase" id="termination">
          Termination
        </h1>
        <p>
          ...
          revoke any or all of your rights granted under the Terms and
          Conditions.
        </p>
        <p>
        ...
        <p>
          Any termination of this agreement shall not affect the respective
          ...
          You furthermore agree that the Site shall not be liable to you or to
