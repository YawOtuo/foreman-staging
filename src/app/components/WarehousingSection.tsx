...
export default function WarehousingSection() {
    return (
        <section className="lg:mt-20 w-full grid grid-cols-1 lg:grid-cols-2 gap-10  items-center justify-center lg:min-h-screen">
            ...
            <div className="order-1 lg:order-2" >
                <h2 className="text-4xl lg:text-6xl font-bold mb-3 text-primary-50">Innovative Warehousing</h2>
